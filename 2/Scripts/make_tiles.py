...
# paths
tiled_dataset = 'Development_Dataset_' + str(tile_size)
...
# testing
make_path('Test_Dev_Tiled', bhi, bhm, bmi, bmm)
make_path('Test_Dev_Tiled', phi, phm, pmi, pmm)
make_path('Test_Dev_Tiled', rhi, rhm, rmi, rmm)
make_path('Test_Dev_Tiled', whi, whm, wmi, wmm)
...
# bipbip
make_tiles(os.path.join(dataset_dir, 'Training', bhi), os.path.join(tiled_dataset, 'Training', bhi), False)
make_tiles(os.path.join(dataset_dir, 'Training', bhm), os.path.join(tiled_dataset, 'Training', bhm), True)
make_tiles(os.path.join(dataset_dir, 'Training', bmi), os.path.join(tiled_dataset, 'Training', bmi), False)
make_tiles(os.path.join(dataset_dir, 'Training', bmm), os.path.join(tiled_dataset, 'Training', bmm), True)

# pead
make_tiles(os.path.join(dataset_dir, 'Training', phi), os.path.join(tiled_dataset, 'Training', phi), False)
make_tiles(os.path.join(dataset_dir, 'Training', phm), os.path.join(tiled_dataset, 'Training', phm), True)
make_tiles(os.path.join(dataset_dir, 'Training', pmi), os.path.join(tiled_dataset, 'Training', pmi), False)
make_tiles(os.path.join(dataset_dir, 'Training', pmm), os.path.join(tiled_dataset, 'Training', pmm), True)

# roseau
make_tiles(os.path.join(dataset_dir, 'Training', rhi), os.path.join(tiled_dataset, 'Training', rhi), False)
make_tiles(os.path.join(dataset_dir, 'Training', rhm), os.path.join(tiled_dataset, 'Training', rhm), True)
make_tiles(os.path.join(dataset_dir, 'Training', rmi), os.path.join(tiled_dataset, 'Training', rmi), False)
make_tiles(os.path.join(dataset_dir, 'Training', rmm), os.path.join(tiled_dataset, 'Training', rmm), True)

# weedelec
make_tiles(os.path.join(dataset_dir, 'Training', whi), os.path.join(tiled_dataset, 'Training', whi), False)
make_tiles(os.path.join(dataset_dir, 'Training', whm), os.path.join(tiled_dataset, 'Training', whm), True)
make_tiles(os.path.join(dataset_dir, 'Training', wmi), os.path.join(tiled_dataset, 'Training', wmi), False)
make_tiles(os.path.join(dataset_dir, 'Training', wmm), os.path.join(tiled_dataset, 'Training', wmm), True)